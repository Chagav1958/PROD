...
### SYBASE-19371 — рефакторинг v_rule_dim_dictionary (папка: SYBASE-19371_19365, 17.07.2026)
...
- **Продолжение только по команде** «продолжить SYBASE-19371». Автопродолжение запрещено. Выбор варианта A/B/C — за аналитиком.
