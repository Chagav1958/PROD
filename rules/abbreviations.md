...
| **МОРДА** | Главное окно GUI (СТАНДАРТ1) | `Launch-GUI.ps1` — `Prod-GUI.ps1` |
| **ДО** | Диалоговое окно сервиса | Пример: VSS History |
| **МОРДА2** | Главное окно GUI СТАНДАРТ2 (новое) | `bin\Prod-GUI_STANDART2.bat` → `Prod-GUI_STANDART2.ps1` |
...
| **ОП** | Операция = вкладка МОРДА/МОРДА2, открывается при выборе операции в окне. Нумерация 1-based. ОП1 = «Настройки параметров», ОП2 = «Запуск тестов» и т.д. (в коде массив `$operations`, индекс = ОП − 1). При работе с МОРДА — «вкладки МОРДА», с МОРДА2 — «вкладки МОРДА2» |
