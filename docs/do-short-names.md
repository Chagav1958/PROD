# Реестр уникальных имён ДО (диалоговых окон)
...
| **Регистр** | Только прописные (БОЛЬШИЕ) буквы |
| **Префикс** | Имя начинается с имени задачи |
| **Уникальность** | Каждое имя уникально в проекте |
